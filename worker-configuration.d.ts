/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be297bca2c10498189d4135422a90bc0)
// Runtime types generated with workerd@1.20260301.1 2025-09-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TenantAgent";
	}
	interface StagingEnv {
		...
		TENANT_AGENT: DurableObjectNamespace<import("./src/index").TenantAgent>;
		PROVISIONING_WORKFLOW: Workflow<Parameters<import("./src/index").TenantProvisioningWorkflow['run']>[0]['payload']>;
	}
	...
	interface Env {
		...
		APP_URL: "https://global-claw-staging.workers.dev" | "https://api.global-claw.com" | "http://localhost:8787";
		DASHBOARD_URL: "https://global-claw-dashboard.pages.dev" | "https://app.global-claw.com" | "http://localhost:3000";
		AI_GATEWAY_SLUG: "global-claw";
		CF_ACCOUNT_ID: "";
		JWT_SECRET: string;
		ENCRYPTION_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_URL" | "DASHBOARD_URL" | "AI_GATEWAY_SLUG" | "CF_ACCOUNT_ID" | "JWT_SECRET" | "ENCRYPTION_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "TELEGRAM_WEBHOOK_SECRET">> {}
}
