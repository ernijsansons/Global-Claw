...
const _viewMode: ViewMode = "timeline";

// Search and filters
const searchQuery = "";
const selectedAgent = "all";
...
// Agents for filter
const _agents = ["Sales-LV", "Sales-EN", "Support-EN", "Support-RU", "Data-Collector"];
const _memoryTypes = ["conversation", "fact", "faq", "entity"];

// Selected memory for detail view
const _selectedMemory: (typeof memoryEntries)[0] | null = null;
...
// Graph interaction
const _hoveredNode: string | null = null;
</script>
