...
const _selectedConversation: (typeof conversations)[0] | null = conversations[0];
...
// Agents for filter
const _agents = ["Sales-LV", "Sales-EN", "Support-EN", "Support-RU"];
const _statusOptions = ["all", "open", "closed", "escalated"];
