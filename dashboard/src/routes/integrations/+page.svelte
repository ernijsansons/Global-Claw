...
// Modal state
let _showManageModal = false;
let _managingIntegration: (typeof connectedIntegrations)[0] | null = null;
...
function openManageModal(integration: (typeof connectedIntegrations)[0]) {
	_managingIntegration = integration;
	_showManageModal = true;
}

function closeManageModal() {
	_showManageModal = false;
	_managingIntegration = null;
}
